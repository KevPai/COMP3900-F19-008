...
{
public:
	//Model constructor, uses the filepath for a 3D object model
...
private:
	...
	{
		//Read in file throug ASSIMP
		Assimp::Importer importer;
		const aiScene* scene = importer.ReadFile(path, aiProcess_Triangulate 
			| aiProcess_FlipUVs);
		//Checking import errors
		if (!scene || scene->mFlags & AI_SCENE_FLAGS_INCOMPLETE || !scene->mRootNode) // if non-zero
		{
